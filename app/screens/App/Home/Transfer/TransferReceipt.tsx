...
export default function TransferReceipt({
  route,
  navigation,
}: RootNavigationProp<AppRoutes, TransferRoutes, 'TransferReceipt'>): JSX.Element {
  const { params } = route;
  ...
  const filename = `Transaction Receipt for ${params.accountName}`;
        ...
        <Container paddingHorizontal={0}>
          <View ref={ref} style={styles.container}>
            ...
            <ReceiptListItem
              ...
              value2={params.accountNumber}
              value3={params.bankName}
            />
            <ReceiptListItem
              label="SENDER"
              value={user?.fullName || ''}
              ...
              value3="Awacash"
            />
            <ReceiptListItem label="Status" value={'-'} />
            <ReceiptListItem label="Narration" value={params.narration} />
            <Divider />
          </View>
        </Container>
